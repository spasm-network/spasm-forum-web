    ...
    <div class="overflow-auto overflow-wrap break-words">
      <div class="text-colorNotImportant-light dark:text-colorNotImportant-dark">
        <span v-if="addressValue && addressForDisplay">
          ...
          <nuxt-link :to="`/authors/${addressValue}`"
        ...
        <nuxt-link
          v-if="extractIdForDisplay(comment)"
...
const addressForDisplay = extractOneAuthorAddressForDisplay(props?.comment)
const addressValue = extractOneAuthorAddressForDisplay(props?.comment, true)
